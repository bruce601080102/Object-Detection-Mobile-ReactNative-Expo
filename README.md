...
**5.開啟ngrok，輸入本機ip位置，並在ngrok裡輸入`ngrok htpp  http://自己的IP:3000`[[ngrok連結說明參見股票機器人](https://github.com/bruce601080102/Line_Web_Stock)] ，會出現對外的網址，將其放入src/screen/Detail.js 中第17行**
